...
Los tres elementos  **replay, red objetivo y actualización de Bellman** según `src/mountain_car/agents/dqn.py`:

1. **Entorno** entrega la observación continua.
...
3. **Selección de acción** — epsilon-greedy **con exploración pegajosa**: al
   ...
   exploratoria en vez de sortear una nueva.
